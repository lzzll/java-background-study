...
//                // 覆盖输出到xxx目录
//                .setFileOverride(true).setOutputDir("G://code")
...
//                // 用户名、密码、驱动、url
//                .setUsername("tiku").setPassword("123456")
//                .setDbType(DbType.MYSQL).setDriverName("com.mysql.jdbc.Driver")
//                .setUrl("jdbc:mysql://192.168.1.116:3306/tiku?useUnicode=true&characterEncoding=utf-8&useSSL=false")
//        );
//        // ===============================包名配置：父包.模块.controller===============================
//        mpg.setPackageInfo(new PackageConfig()
//                // 父包名 模块名
//                .setParent("com.canpoint.itembank.factory.modules").setModuleName("flow")
//                // 分层包名
